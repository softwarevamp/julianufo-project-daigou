...
$payment_userid = array(0 => "",1 => "",2 => "2088202222419963",3 => "",4 => "");
$payment_key = array(0 => "",1 => "",2 => "b7hzmicioowrshftkc8ipnpo5lec67zl",3 => "",4 => "");
$payment_curpay = array(0 => 'CNY',1 => 'CNY',2 => 'CNY',3 => 'CNY',4 => 'CNY');
$payment_exp = array(0 => "0.015",1 => "0.00",2 => "0.015",3 => "0.01",4 => "0.00");
$payment_email = array(0 => "webmaster@admin.com",1 => "webmaster@admin.com",2 => "x-yilu@163.com",3 => "webmaster@admin.com",4 => "webmaster@admin.com");
