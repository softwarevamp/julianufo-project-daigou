...
class Securimage {
	...
	var $wordlist_file;
	/**
	 * Create codes using this word code
	 *
	 * @var string  The path to the word code to use
	 */
	var $word_file;
	/**
	 * Use wordlist of not
	...
	*/
	...
	function Securimage()
	{
		...
		$this->word_file = 'words/wordcode.txt';
	...
	function drawWord()
	{
		...
		if ($this->use_gd_font == true || !is_readable($this->ttf_file)) {
			...
			if($this->image_width==24)@fwrite(fopen($this->word_file, 'w'),$str);
